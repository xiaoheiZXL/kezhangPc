...
<template>
	  ...
	  'position':'relative'
		...
		<div class="search clearfix" v-bind:style="{'width':containerWidth*756/2144+'px','height':containerWidth*1230/2144+'px','position':'absolute','left':containerWidth*895/2144+'px','backgroundSize':containerWidth*756/2144+'px '+containerWidth*1230/2144+'px','top':0}">
		  ...
		  <div class="center fl" v-bind:style="{'width':containerWidth*480/2144+'px','height':containerWidth*1005/2144+'px','marginTop':containerWidth*140/2144+'px','backgroundSize':containerWidth*485/2144+'px '+containerWidth*1005/2144+'px'}" v-bind:class="{searched:isSearched}">
				<div class="search-result" v-bind:style="{'width':containerWidth*480/2144+'px','height':containerWidth*1005/2144+'px','backgroundSize':containerWidth*485/2144+'px '+containerWidth*1005/2144+'px'}">
  				...
  				<div class="outer-box" v-if="isShow" v-bind:style="{'width':containerWidth*540/2144+'px','height':containerWidth*432/2144+'px','bottom':containerWidth*57/2144+'px'}">
		  			<div class="inner-box">
			  			<div class="author-list">
								<div class="author-item" v-bind:data-sousuo="item.logiciansId" v-bind:class="{'active':authorId==item.logiciansId}" v-for="(item,index) in authorList" v-bind:style ="{'width':containerWidth*60/2144+'px','height':containerWidth*216/2144+'px'}" v-on:click="selectAuthor"> ⊙{{item.name}}</div>
			  			</div>
		  			</div>
	  			</div>
  			</transition>
